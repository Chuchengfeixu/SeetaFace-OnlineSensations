...
int main(int argc, char* argv[]) {
  ...
  //load image
  Mat gallery_img_color = imread(test_dir + "images/compare_im/Aaron_Peirsol_0004.jpg", 1);
  Mat gallery_img_gray;
  cvtColor(gallery_img_color, gallery_img_gray, CV_BGR2GRAY);

  Mat probe_img_color = imread(test_dir + "images/compare_im/Aaron_Peirsol_00011.jpg", 1);
  Mat probe_img_gray;
  cvtColor(probe_img_color, probe_img_gray, CV_BGR2GRAY);
  ...
  imwrite("gallery_point_result.jpg", gallery_img_color);
  imwrite("probe_point_result.jpg", probe_img_color);
